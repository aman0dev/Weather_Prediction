...
def getWeather():
    ...
    long_lat.config(text=f"{round(location.latitude,4)}°N{round(location.longitude,4)}°S")
...
#current
    ...
    tempday2=json_data['daily'][0]['temp']['day']
    tempnight2=json_data['daily'][0]['temp']['night']
    ...
    tempday3=json_data['daily'][0]['temp']['day']
    tempnight3=json_data['daily'][0]['temp']['night']
    ...
    tempday4=json_data['daily'][0]['temp']['day']
    tempnight4=json_data['daily'][0]['temp']['night']
    ...
    tempday5=json_data['daily'][0]['temp']['day']
    tempnight5=json_data['daily'][0]['temp']['night']
    ...
    tempday6=json_data['daily'][0]['temp']['day']
    tempnight6=json_data['daily'][0]['temp']['night']
    ...
    tempday7=json_data['daily'][0]['temp']['day']
    tempnight7=json_data['daily'][0]['temp']['night']
...
#label
labell=Label(root,text="Temperature",font=('Helvetica',11),fg="white",bg="#203243")
labell.place(x=50,y=120)
...
dayA=Label(firstframe,font="arial 20", bg="#282829", fg="#fff")
dayA.place(x=40,y=5)
...
#days
first = datetime.now()
dayA.config(text=first.strftime("%A"))
